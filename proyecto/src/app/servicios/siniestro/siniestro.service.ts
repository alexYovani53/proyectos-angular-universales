...
export class SiniestroService {
  ...
  buscarSiniestros(){
    return this.consumirGet("/siniestros/GetAll");
  }


  agregarSiniestro(siniestros:any){
    return this.consumirPost("/siniestros/post",siniestros);
  }
  ...
  buscarSiniestrosPaginador(pagina:number,filas:number){
    return this.consumirGet(`/siniestros/paginador/${pagina}/${filas}`)
  }
